  ...
  return (
    <div className="flex items-center justify-center bg-[#DEEFF9] small-bg-city bg-no-repeat bg-bottom h-[280px]  w-[full] ">
        ...
        <div className="min-h-[77px]  flex flex-col items-start gap-4 ">
            ...
            <div  className=" grid grid-cols-2  lg:flex lg:justify-center gap-8	 rounded  px-3.5 py-4  border bg-white ">
            ...
            <select id="OfferTypeField"  className="min-w-40 h-9  rounded border text-[#6C757D]">
              <option value="arabic">All Offers</option>
                ...
                <button  className="min-w-40 h-9 rounded  bg-[#0E88E2] hover:bg-[#40aeff] duration-150 text-white ">Search</button>
            </div>
